...
export const makeKiroTextGeneration = Effect.fn("makeKiroTextGeneration")(function* (
    ...
    Effect.gen(function* () {
      ...
      const promptResult = yield* Effect.gen(function* () {
        ...
        yield* applyKiroAcpModelSelection({
          ...
          mapError: (cause) =>
            new TextGenerationError({
              operation,
              detail: "Failed to set Kiro ACP base model for text generation.",
              cause,
            }),
        });
        ...
        Effect.flatMap(
          Option.match({
            onNone: () =>
              Effect.fail(
                new TextGenerationError({ operation, detail: "Kiro ACP request timed out." }),
              ),
        ...
        Effect.mapError((cause: EffectAcpErrors.AcpError | TextGenerationError) =>
          isTextGenerationError(cause)
            ...
            : new TextGenerationError({
                operation,
                detail: "Kiro ACP request failed.",
                cause,
              }),
        ),
      );
      ...
      Effect.mapError((cause) =>
        isTextGenerationError(cause)
          ...
          : new TextGenerationError({
              operation,
              detail: "Kiro ACP text generation failed.",
              cause,
            }),
      ),
      Effect.scoped,
  ...
  const generateCommitMessage: TextGeneration.TextGeneration["Service"]["generateCommitMessage"] =
    Effect.fn("KiroTextGeneration.generateCommitMessage")(function* (input) {
  ...
  const generatePrContent: TextGeneration.TextGeneration["Service"]["generatePrContent"] =
    Effect.fn("KiroTextGeneration.generatePrContent")(function* (input) {
  ...
  const generateBranchName: TextGeneration.TextGeneration["Service"]["generateBranchName"] =
    Effect.fn("KiroTextGeneration.generateBranchName")(function* (input) {
  ...
  const generateThreadTitle: TextGeneration.TextGeneration["Service"]["generateThreadTitle"] =
    Effect.fn("KiroTextGeneration.generateThreadTitle")(function* (input) {
